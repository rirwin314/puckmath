...
from puckmath.core.builder.utils import format_team_abbr
...
class PeriodStart(Play):
    ...
    def __init__(self, **kwargs):
        ...
        self.period_start_time = _text_to_time(_tm_str)
...
class PeriodEnd(Play):
    ...
    def __init__(self, **kwargs):
        ...
        _tm_str = self.description.split(' ')[-2]
        self.period_end_time = _text_to_time(_tm_str)
...
class GameEnd(Play):
    ...
    def __init__(self, **kwargs):
        ...
        _tm_str = self.description.split(' ')[-2]
        self.game_end_time = _text_to_time(_tm_str)
...
class ShootoutCompleted(Play):
    ...
    def __init__(self, **kwargs):
        ...
        _tm_str = self.description.split(' ')[-2]
        self.shootout_end_time = _text_to_time(_tm_str)
