...
from puckmath.core.schema.Game import Game, GameLinesmanAssociation, GameOfficialAssociation
from puckmath.core.schema.GamePlayerAssociation import GamePlayerAssociation, PeriodTOISummary
from puckmath.core.schema.Scratch import Scratch
from puckmath.core.schema.Shift import Shift
from puckmath.core.schema.Player import Player
from puckmath.core.schema.Official import Official
from puckmath.core.schema.Linesman import Linesman
from puckmath.core.schema.Play import PlayerOnIce, Play, PLAY_CONSTRUCTOR_MAP
from puckmath.core.tools.NHLParser import *
...
class GameFactory(object):
    ...
    @staticmethod
    def _build_game_id(season, game_type, game_num):
    ...
    def build(self, session, season, game_type, game_num, src_path='.', ignore_existing=True):
        ...
        #
        self.game_id = self._build_game_id(self.season, self.game_type, self.game_num)
